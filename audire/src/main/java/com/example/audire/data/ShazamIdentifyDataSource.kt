...
import com.example.audire.converters.toMusic
import com.example.audire.converters.toShortArray
...
import com.example.audire.shazam.ShazamRetrofitInstance
import com.example.audire.shazam.models.ShazamRequestBody
...
class ShazamIdentifyDataSource : IdentifyDataSource {
    ...
    override fun identify(data: ByteArray, duration: Int): Music? = runBlocking {
